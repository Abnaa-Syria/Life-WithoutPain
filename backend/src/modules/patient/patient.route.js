...
router.use('/medical-catalog', require('./medical-catalog.patient.routes'));
router.use('/medical-profile', require('./medical-profile.patient.routes'));
router.use('/medical-timeline', require('./medical-timeline.patient.routes'));
...
router.use('/bookings', require('./bookings.patient.routes'));
...
router.use('/sub-specializations', require('./sub-specializations.patient.routes'));
router.use('/services', require('./services.patient.routes'));
router.use('/directories', require('./directories.patient.routes'));
router.use('/', require('./records.patient.routes'));
