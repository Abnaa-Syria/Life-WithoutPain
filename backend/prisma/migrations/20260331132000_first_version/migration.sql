...
CREATE TABLE `support_cases` (
    ...
    `type` ENUM('INSURANCE', 'TECHNICAL', 'BILLING', 'GENERAL', 'COMPLAINT') NOT NULL,
    `priority` ENUM('LOW', 'MEDIUM', 'HIGH', 'URGENT') NOT NULL DEFAULT 'MEDIUM',
    `status` ENUM('OPEN', 'IN_PROGRESS', 'WAITING_ON_PATIENT', 'WAITING_ON_INSURANCE', 'ESCALATED', 'RESOLVED', 'CLOSED') NOT NULL DEFAULT 'OPEN',
    ...
    INDEX `support_cases_type_idx`(`type`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `payments` (
    ...
    `method` ENUM('CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'WALLET', 'INSURANCE', 'CASH') NULL,
